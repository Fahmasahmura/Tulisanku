					...
					<form action="deletepost.php" method="POST" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="form-group">
								...
								<select disabled class="form-control" name="post-category" id="post-category"
									value="<?php echo $post_category ?>">
									<?php
							...
							<label>Existing Image: <img src="Upload/Image/<?php echo $post_image; ?>" width='250'
									height='90'> </label>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea disabled rows="20" class="form-control" name="post-content" id="post-content"><?php echo htmlentities($post_content);
								mysqli_close($con); ?></textarea>
							</div>
